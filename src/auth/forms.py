...
class RegistrationForm(FlaskForm):
    ...
    last_name = StringField('Enter your Last Name',
                            validators=[Length(min=2, max=40), Optional()])
    ...
    email = EmailField('Enter your Email',
                       validators=[DataRequired(), InputRequired(), Email()])
    password = PasswordField('Enter your Password',
                             validators=[DataRequired(), InputRequired(), Length(min=8)])
...
class LoginForm(FlaskForm):
    ...
    """
    username_or_email = StringField('Enter your Username or Email',
...
class ProfileForm(FlaskForm):
    ...
    Methods:
        ...
        - validate_email
    """
    first_name = StringField('Update your First Name',
                             validators=[Length(min=2, max=20), Optional()])
    last_name = StringField('Update your Last Name',
                            validators=[Length(min=2, max=40), Optional()])
    username = StringField('Update your Username',
                           validators=[DataRequired(), Length(min=2, max=20)])
    email = EmailField('Update your Email',
                       validators=[DataRequired(), Email()])
    image = FileField('Update your Avatar',
